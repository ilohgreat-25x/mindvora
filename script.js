...
var RECAPTCHA_SITE_KEY = window.RECAPTCHA_SITE_KEY || ''; // set in index.html config block
...
// NOTE: the $1 credit itself happens on the backend (lib/referral-integrity.js),
// not here — it only pays out once this new user proves they're real by
// posting, sending/receiving a gift, or referring someone themselves.
...
// Store the referral record — backend picks this up once `paid` should flip to true
...
// Hide OTP screen + mount the app (called after email verification)
